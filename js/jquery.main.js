...
function initValidation() {
	var errorClass = 'error-row';
	var successClass = 'success';
	var link = jQuery('a.submit');
	...
	jQuery('form.contact-form').each(function(){
		...
		function checkField(i, obj) {
			...
			var currentParent = currentObject.parent('div');
...
jQuery.fn.scrollGallery = function(options){
	...
	return this.each(function(){
		...
		var pauseButton = jQuery(options.pauseButton, holder);
		var pauseOnHover = options.pauseOnHover;
		var pauseClass = options.pauseClass;
		...
		slides.each(function(){
			...
			if(autoHeight)slider.height(slides.eq(currentStep).outerHeight(true));
		});
		...
		if(pauseButton.length) {
			pauseButton.click(function(){
				if(holder.hasClass(pauseClass)) {
					holder.removeClass(pauseClass);
					autoRotation = true;
					autoSlide();
				} else {
					holder.addClass(pauseClass);
					stopAutoSlide();
				}
				return false;
			});
